            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    <form name='purchaseForm' onSubmit={onHandleSubmit}>
                        <input name='pName' type="text" value={singleTool.Name} disabled class="input input-bordered w-full max-w-xs mb-2" />
                        <input name='name' type="text" value={user.displayName} disabled class="input input-bordered w-full max-w-xs mb-2" />
                        <input name='email' type="email" value={user.email} disabled class="input input-bordered w-full max-w-xs mb-2" />
